...
selected_forehead_breadth = st.selectbox("Face Size",forehead_breadth)
selected_hair_nature = st.selectbox("Face Size",hair_nature)
selected_hands_length = st.selectbox("Face Size",hands_length)
selected_palate_color = st.selectbox("Face Size",palate_color)
